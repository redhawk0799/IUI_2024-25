...
def acUpdate(deltaT):
    ...
    try:
        ...
        OurTest += "f"; OurList.append(ac.getCarState(0, acsys.CS.WorldPosition)[2])
        OurTest += "f"; OurList.append(ac.getCarState(0, acsys.CS.SpeedKMH))
        ...
        OurInfo = struct.pack(OurTest, *OurList)
        ...
        for iHost in range(3):
            if acti.udp2_dataflow_ip[iHost] != "":
                ...
                acti.udp2_socket.sendto(OurInfo, (acti.udp2_dataflow_ip[iHost], acti.ACTI_UDP2_PORT2))
